...
\begin{frame}{Schema di annotazione}
Nle presente schema di annotazione, si osservano i seguenti consraint e distribuzioni.
    
    \begin{itemize}
        \item \textbf{greater plurality/accumulation} \\
        Si asscia a costruzioni istanziate dalla preposizione \textbf{SU}.
        \item \textbf{juxtaposition/contact} \\
        Si asscia a costruzioni istanziate dalla preposizione \textbf{A}.
    \end{itemize}

Per quanto riguarda l'alternanza tra \textbf{succession/iteration/distributivity} e \textbf{greater plurality/accumulation}, entrambe le etichette sono istanziate da costruzioni istanziate dalla preposizione \textbf{SU}, preferibilmente, ma non esclusivamente:

    \begin{itemize}
        \item \textbf{greater plurality/accumulation} \\
        Si associa a lemmi \textbf{plurali}.
        \item \textbf{succession/iteration/distributivity}  \\
         Si associa a lemmi \textbf{singolari}.
    \end{itemize}
\end{frame}
